...
RUN echo -n "# Remote IP configuration" >> /etc/apache2/apache.conf 
RUN echo -n "RemoteIPHeader X-Real-IP" >> /etc/apache2/apache.conf 
RUN echo -n "RemoteIPTrustedProxy https" >> /etc/apache2/apache.conf 
